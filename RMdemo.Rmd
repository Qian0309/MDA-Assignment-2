...
```{r a dendrogram, echo = FALSE, fig.height = 4, fig.width = 5}
...
Then, we want to use a hierarchical clustering algorithm and select a sensible number of clusters according to the results.

Note that a number of measures or indexes have been proposed for cluster validation, comparison, decision about the number of clusters, etc. Several of them are implemented through the function cluster.stats in the R package fpc. For illustration, we focus on the $Calinski$ $and$ $Harabasz$
$index$ (CH index, Calinski and Harabasz, 1974) and the $average$ $silhouette$ $width$ (ASW).
...
```{r plot 4-cluster dendrogram, echo = FALSE, fig.height = 4, fig.width = 5}
...
```{r plot for analysis, echo = FALSE, fig.height = 3.5, fig.width = 4}
